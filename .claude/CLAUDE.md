...
**Core Value:** **The dashboard stays accurate without me remembering to update it.** Every prior attempt died at capture, not display — if this one requires discipline to stay true, it has already failed.
